  ...
  return (
    <div className="flex justify-center  ">
      ...
      <div className={`flex flex-col h-screen ${blur ? "blur" : ""}`}>
        ...
        <div className="">
          <div className="flex flex-col lg:mt-3 sm:mt-0 sm:mx-2 lg:mx-6 ml-5">
            <div className="flex">
          ...
          <div className="flex ml-6 mb-3 sm:mx-2 lg:mx-6 -mt-2">
            <p className="text-gray-100  font-light ">{userData.bio}</p>
          </div>
          <div className="flex lg:gap-8 sm:mx-2 lg:mx-6 sm:gap-4 ml-5 mt-2 my-2">
            ...
            <div className="flex sm:mx-2 lg:mx-6 items-center">
              <img
          ...
          <div className="flex sm:mx-2 lg:mx-6 text-white font-medium gap-4 text-lg ml-5 mt-2 items-center">
            <p>
              {followers}{" "}
